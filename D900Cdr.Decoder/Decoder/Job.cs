...
namespace D900Cdr.Decoder
{
    ...
    public class JobBase : IDecoderJob
    {
        ...
        public JobBase()
        {
            ...
            _definitionSchema = D900CdrDefinitionProvider.Instance.DefaultSchema;
            D900CdrDefinitionProvider.Instance.CurrentSchema = _definitionSchema;
        }
        ...
        [Description("All definition schemas describe in the file D900Cdr.Elements.xml. By default, the last scheme with attribute <Default = 'true'> or the first scheme in this file.")]

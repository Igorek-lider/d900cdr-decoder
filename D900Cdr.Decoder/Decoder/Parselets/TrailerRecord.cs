...
namespace D900Cdr.Decoder.Parselets
{
    ...
    /// </summary>
    class FileSizeParselet : GenericParselet
    {
        public FileSizeParselet()
            : base()
        {
    ...
    /// Attention: coding a and b were switched in CS3.0.
    /// </summary>
    class NumberOfRecordsParselet : GenericParselet
    {
        public NumberOfRecordsParselet()
            : base()
        {
            RegisterMethod("Coding_A", ValueAsInteger);
            RegisterMethod("Coding_B", ValueAsString);
    ...
    /// </summary>
    class ExtensionFileNumber : GenericParselet
    {
        public ExtensionFileNumber()
            : base()
        {
            RegisterMethod("Coding_A", ValueAsInteger);
            RegisterMethod("Coding_B", ValueAsString);
